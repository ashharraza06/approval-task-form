		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#formworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"formworkflowuimodule-display": {
								"semanticObject": "formworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=form.workflowuimodule",
									"url": sap.ui.require.toUrl("form/workflowuimodule")
								}
							}
						}
					}
